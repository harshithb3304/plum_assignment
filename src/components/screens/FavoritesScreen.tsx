        ...
        <div className="mb-6">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Your Favorite Tips</h1>
            </div>
        ...
        {favoriteTips.length === 0 ? (
          <Card className="text-center bg-white/80 dark:bg-white/5 backdrop-blur-sm border-blue-200 dark:border-blue-800/50">
            <CardContent className="pt-6 pb-8">
              ...
              <CardTitle className="mb-2 text-gray-900 dark:text-white">No Favorites Yet</CardTitle>
          ...
          <>
            <div className="mb-4 text-sm text-gray-600 dark:text-white/70">
              {favoriteTips.length} tip{favoriteTips.length !== 1 ? 's' : ''} saved
            </div>
              ...
              {favoriteTips.map((tip) => (
                ...
                >
                  <CardHeader className="pb-3">
                    ...
                    <CardTitle className="text-lg line-clamp-2 text-gray-900 dark:text-white">{tip.title}</CardTitle>
                  </CardHeader>
                  <CardContent>
                    ...
                    <Badge 
                      className={`text-xs ${CATEGORY_COLORS[tip.category as keyof typeof CATEGORY_COLORS] || 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200'}`}
                      variant="secondary"
                    >
